...
function CadastroCliente() {
  ...
  const [modalNovoClienteVisivel, setModalNovoClienteVisivel] = useState(false);
  ...
  const adicionarCliente = (event) => {
    ...
    setModalNovoClienteVisivel(false);
  ...
  return (
    <div>
      ...
      <main>
        ...
        <h1 className="m-5 text-center">Cadastro de Cliente</h1>
        <button
          type="button"
          className="btn btn-primary d-block m-auto"
          onClick={() => setModalNovoClienteVisivel(true)}
        >
          Novo Cliente
        </button>

        {/* Modal de Cadastro */}
        {modalNovoClienteVisivel && (
          <div
            className="modal fade show"
            id="novoClienteModal"
            tabIndex="-1"
            aria-labelledby="novoClienteModalLabel"
            aria-hidden="true"
            ...
            <div className="modal-dialog">
              <div className="modal-content modal-cadastro bg-dark text-light">
                <div className="modal-header">
                  <h1 className="modal-title fs-5" id="novoClienteModalLabel">
                    Cadastrar novo cliente
                  </h1>
                  <button
                    type="button"
                    className="btn-close btn-close-white"
                    onClick={() => setModalNovoClienteVisivel(false)}
                    aria-label="Close"
                  ></button>
                </div>
                <div className="modal-body modal-cadastro bg-dark">
                  <form onSubmit={adicionarCliente}>
                    <div className="cadastro card bg-dark border-light">
                      <label htmlFor="cpfCliente" className="form-label text-light">CPF (opcional)</label>
                      <input
                        type="text"
                      ...
                      <label htmlFor="telefoneCliente" className="form-label text-light">Telefone</label>
                      <input
                        type="text"
                        className="form-control bg-secondary text-light"
                        id="telefoneCliente"
                      ...
                      <label htmlFor="nomeCliente" className="form-label text-light">Nome</label>
                      <input
                        type="text"
                        className="form-control bg-secondary text-light"
                        name="nome"
                      ...
                      <label htmlFor="dataNascimento" className="form-label text-light">Data de Nascimento</label>
                      <input
                        type="date"
                        className="form-control bg-secondary text-light"
                        name="dataNascimento"
                  ...
                  <form onSubmit={salvarEdicaoCliente}>
                    <div className="cadastro card bg-dark border-light">
                      ...
                      <input
                        ...
                        maxLength="16"
                        placeholder="(79) 9 9999-9999"
                        value={clienteEditando?.telefone || ''} onChange={handleEditarInputChange}
                        required
                        onInput={(e) => {
                          let telefone = e.target.value;
                          telefone = telefone.replace(/\D/g, '');
